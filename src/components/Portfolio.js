...
<Container>
  <Row>
    ...
    <img style={{width:'89%'}}onMouseEnter={()=>this.show('npmProject')} src={npmImage}  alt="" />}
    {this.state.npmProject && 
    <img style={{height:'33%'}}
    ...
    <img style={{width:'46%'}}onMouseEnter={()=>this.show('ioscodecommando')} src={ioscodecommando}  alt="" />}
    {this.state.ioscodecommando && 
    <img style={{width:'45%'}}
    onMouseLeave={()=>this.hide('ioscodecommando')} src={iosGif}  alt="" />}
    ...
    <Col md={4}>
      ...
      <img style={{width: '69%'}} src='https://github.com/mrebb/my-portfolio/blob/master/src/assets/codecommando.png?raw=true' alt="" />
  ...
  <Row style={{marginTop:'5%'}}>
    ...
    <img style={{height:'32%'}}src={'https://github.com/mrebb/my-portfolio/blob/master/src/assets/bitfellows.png?raw=true'} alt="" />
      <p className="project-description">Built a Full Stack javascript application using Node.JS, Page.JS, Chart.js, HTML &#38; CSS. Solution provides a way to search cryptocurrency coins and collect the historical data by making API calls to 3rd Party bitcoin exchange. Solution also records user interactions on coin search trends that can be further fed to Bitcoin sellers in the market. </p>
  ...
  <Row style={{marginTop:'5%'}}>
    <Col md={4}>
      ...
      <div className="card-footer"><a style={{fontWeight:'bold',textDecoration: 'none'}}href="https://www.microsoft.com/en-us/legal/diversity/ourworkincela">View Source </a></div>
    </Col>
    <Col md={4}>
    ...
    <Col md={4}>
      ...
      <img style={{width: '90%',height:'37.5%'}} src='https://github.com/mrebb/my-portfolio/blob/master/src/assets/mtnl.png?raw=true' alt="" />
      ...
      <div className="card-footer"><a style={{fontWeight:'bold',textDecoration: 'none'}}href="https://github.com/mrebb/react-native-redux-sidemenu-navigator-cli">View Source </a></div>
    </Col>
  </Row>
</Container>
  </section>
